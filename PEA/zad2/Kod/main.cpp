...
int main(){
    ...
    while (choice != 0){
        ...
        std::cout << "5. Pomiary czasowe algorytmow BreadthFS i BestFS dla 10 rozmiarow problemu\n";
        std::cout << "0. Wyjscie\n";
        std::cout << "Wybor: ";
        std::cin >> choice;
        switch (choice){
        ...
        case 4:
            ...
            case 1:
                ...
                std::cout << "Czas: " << resultBFS.timeMicroseconds << " ms\n";
                std::cout << "Sciezka: ";
            ...
            case 2:{
                ...
                std::cout << "Czas: " << resultBestFS.timeMicroseconds << " ms\n";
                std::cout << "Sciezka: ";
        ...
        case 5:{
            ...
            std::cout<<"Podaj startowy rozmiar problemu (program wykona BnB dla dla 10 kolejnych rozmiarow zaczynajac od podanego)"<<std::endl;
            std::cin>>startN;
